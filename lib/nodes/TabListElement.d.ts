 ...
 *
 */
export default class TabListElement extends DirectoryElement implements DirectoryElement, CompositeElement {
    /**
     ...
     */
    readonly activeDescendant: ARIAAttribute<"aria-activedescendant">;
    /**
     * Tab List Element Wrapper Class
     *
     * @version 1.0.0
